...
const ToolsSection = () => {
  ...
  return (
    <section className="py-24 bg-black border-t border-zinc-900 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 w-64 h-64 bg-neon-cyan/5 blur-[120px] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="lg:w-1/3 space-y-6">
            ...
            >
              The Doctor's <br />
              <span className="text-neon-cyan" style={{ filter: 'drop-shadow(0 0 15px rgba(var(--neon-cyan-rgb), 0.4))' }}>Trusted Tools</span>
            </motion.h3>
          ...
          <div className="lg:w-2/3 grid grid-cols-2 md:grid-cols-3 gap-6 w-full">
            {toolImages.map((tool, idx) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`group relative aspect-square bg-zinc-900/50 rounded-2xl overflow-hidden border border-white/5 hover:border-neon-cyan/50 transition-all duration-500 ${idx === 2 ? 'col-span-2 md:col-span-1' : ''
                  }`}
              >
                {/* Tool Image */}
                <img
                ...
                <div className="absolute bottom-4 left-4 translate-y-4 group-hover:translate-y-0 opacity-0 group-hover:opacity-100 transition-all duration-300">
                  <p className="text-[10px] font-mono text-neon-cyan uppercase tracking-widest mb-1 flex items-center gap-1">
                ...
                <div className="absolute top-0 left-0 w-full h-[2px] bg-neon-cyan/30 -translate-y-full group-hover:animate-scan pointer-events-none" />
              </motion.div>
            ))}
          </div>
        </div>
