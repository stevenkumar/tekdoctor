      ...
      <div className="p-7 space-y-5 flex-grow flex flex-col">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            <p className="text-2xl font-black text-white tracking-tighter" suppressHydrationWarning>
        ...
        <div className="space-y-3">
          <h3 className="text-xl font-bold text-white group-hover:text-neon-cyan transition-colors duration-300">{product.name}</h3>
          <p className="text-sm text-zinc-400 line-clamp-2 leading-relaxed font-medium">{product.description || 'Professional technology solution for enterprise and consumer needs.'}</p>
        </div>
        ...
        <div className="p-4 bg-zinc-950/40 border border-zinc-800/50 rounded-2xl space-y-2">
          ...
          <p className="text-xs text-zinc-300 line-clamp-2 font-medium leading-snug">{product.specs || 'Enterprise Standard Specifications'}</p>
        </div>
        ...
        <div className="pt-4 mt-auto border-t border-zinc-800/40 flex items-center justify-between">
          ...
          <button
            ...
            className={`px-5 py-2.5 rounded-xl text-[11px] font-black uppercase tracking-wider transition-all duration-300 flex items-center gap-2 shadow-lg ${
              isRental
