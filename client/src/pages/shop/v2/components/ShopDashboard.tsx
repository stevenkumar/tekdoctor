  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 pt-12 space-y-8">
        ...
        {/* Lab Tools Spotlight (Always visible at bottom or as section) */}
            ...
            >
              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] border ${selectedProduct.type === 'rental' ? 'bg-purple-500/10 border-purple-500/30 text-purple-400' : 'bg-neon-cyan/10 border-neon-cyan/30 text-neon-cyan'
                    }`}>
